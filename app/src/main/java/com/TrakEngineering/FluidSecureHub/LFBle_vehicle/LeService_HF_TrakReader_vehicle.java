...
public class LeService_HF_TrakReader_vehicle extends Service {
    private final static String TAG = LeService_HF_TrakReader_vehicle.class.getSimpleName();
...
//       private String UUID_char="0000ff01-0000-1000-8000-00805f9b34fb"; //Third characteristic UUID
    ...
    private LeService_HF_TrakReader_vehicle mBluetoothLeServiceRfidPin;
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.TrakEngineering.FluidSecureHubTest.LFBle_vehicle.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.TrakEngineering.FluidSecureHubTest.LFBle_vehicle.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.TrakEngineering.FluidSecureHubTest.LFBle_vehicle.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.TrakEngineering.FluidSecureHubTest.LFBle_vehicle.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.TrakEngineering.FluidSecureHubTest.LFBle_vehicle.EXTRA_DATA";
    ...
    public class LocalBinder extends Binder {
        public LeService_HF_TrakReader_vehicle getService() {
            return LeService_HF_TrakReader_vehicle.this;
        }
    }
    ...
    private final IBinder mBinder = new LeService_HF_TrakReader_vehicle.LocalBinder();
        ...
        try {
            ...
            if (mCustomService == null) {
                ...
                if (AppConstants.GenerateLogs)
                    AppConstants.WriteinFile("LeService_HF_TrakReader_vehicle ~~~~~~~~~" + "readCustomCharacteristic Custom BLE Service not found");
            ...
            if (mBluetoothGatt.readCharacteristic(mReadCharacteristic) == false) {
                ...
                if (AppConstants.GenerateLogs)
                    AppConstants.WriteinFile("LeService_HF_TrakReader_vehicle ~~~~~~~~~" + "readCustomCharacteristic Failed to read characteristic");
                ...
                if (AppConstants.GenerateLogs)
                    AppConstants.WriteinFile("LeService_HF_TrakReader_vehicle ~~~~~~~~~" + "Read Characteristics successfully");
                //  Toast.makeText(getApplicationContext(),"Read Characteristics successfully!", Toast.LENGTH_LONG).show();
            }

        } catch (Exception e) {
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_HF_TrakReader_vehicle ~~~~~~~~~" + "Read Characteristics Ex-" + e.getMessage());
    ...
    public void writeCustomCharacteristic(int value, String bleCommand) {
        ...
        if (mCustomService == null) {
            Toast.makeText(getApplicationContext(), "Not found: " + UUID_char, Toast.LENGTH_LONG).show();
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_HF_TrakReader_vehicle ~~~~~~~~~" + "writeCustomCharacteristic Char Not found:" + UUID_char);
            return;
        }
...
//            byte bleBytes[] = bigInt.toByteArray();//create a byte array
        ...
        if (mBluetoothGatt.writeCharacteristic(mWriteCharacteristic)) {
            ...
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_HF_TrakReader_vehicle ~~~~~~~~~" + "Write Characteristics successfully!");
        } else {
            // Toast.makeText(getApplicationContext(),"Failed to write Characteristics", Toast.LENGTH_LONG).show();
            if (AppConstants.GenerateLogs)
                AppConstants.WriteinFile("LeService_HF_TrakReader_vehicle ~~~~~~~~~" + "Failed to write Characteristics");
        }
    }
