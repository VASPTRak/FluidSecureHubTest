                            ...
                            if (OdometerReasonabilityConditions.trim().equalsIgnoreCase("1")) {
                                ...
                                if (C_AccOdoMeter >= PO && C_AccOdoMeter <= OL) {
                                    ...
                                    if (cnt123 > 3) {
                                        ...
                                        editOdoTenths.setText("");
                                        CommonUtils.AlertDialogAutoClose(AcceptOdoActivity.this, "Message", "The "+ScreenNameForOdometer+" you have entered is not within the reasonability that has been set for this "+ScreenNameForVehicle+". Please contact your Manager.");
                                        Istimeout_Sec = true;
                                        ResetTimeoutOdoScreen();
