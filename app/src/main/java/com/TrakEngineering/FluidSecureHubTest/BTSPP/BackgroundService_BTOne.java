...
public class BackgroundService_BTOne extends Service {
    ...
    public void ProceedToPostTransactionCommands() {
        ...
        if (CommonUtils.checkBTVersionCompatibility(versionNumberOfLinkOne, BTConstants.supportedLinkVersionForLast20) && IsEleventhTransaction.equalsIgnoreCase("true")) { // Last20 command supported from this version onwards
            last20Command();
        } else if (CommonUtils.checkBTVersionCompatibility(versionNumberOfLinkOne, BTConstants.supportedLinkVersionForBypassPumpReset)) { // Bypass pump reset command supported from this version onwards
