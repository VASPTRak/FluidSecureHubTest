...
public class BackgroundService_BTOne extends Service {
    ...
    public void ProceedToPostTransactionCommands() {
        ...
        if (versionNumberOfLinkOne >= 1411) { // Last20 command supported from this version onwards
            last20Command();
        } else if (versionNumberOfLinkOne >= 148) { // Bypass pump reset command supported from this version onwards
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    if (attempt > 0) {
                        if (Request.equalsIgnoreCase(BTConstants.last20_cmd) && Response.contains("records")) {
                            ...
                            if (AppConstants.GenerateLogs)
                                AppConstants.WriteinFile(TAG + " BTLink_1: Checking last20 command response. Response:>>" + Response.trim());
    ...
    private void ProceedToNextCommand() {
        if (versionNumberOfLinkOne >= 1412) { // CheckMOStatus command supported from this version onwards
