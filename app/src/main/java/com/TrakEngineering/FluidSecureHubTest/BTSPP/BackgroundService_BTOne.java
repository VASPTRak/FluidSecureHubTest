...
public class BackgroundService_BTOne extends Service {
    ...
    private void transactionIdCommand(String transactionId) {
        ...
        try {
            ...
            if (IsThisBTTrnx) {
                BTSPPMain btspp = new BTSPPMain();
                btspp.send1(BTConstants.transaction_id_cmd +"T:"+ transactionId+";D:"+TransactionDateWithFormat+";V:"+VehicleNumber+";");
            } else {
            ...
            Log.i(TAG, "BTLink 1: In Request>>" + BTConstants.transaction_id_cmd +"T:"+ transactionId+";D:"+TransactionDateWithFormat+";V:"+VehicleNumber+";");
    ...
    private  void parseInfoCommandResponseForLast20txtn(String response){
        ...
        try{
            ...
            e.printStackTrace();
            if (AppConstants.GenerateLogs)AppConstants.WriteinFile(TAG + "BTLink 1: parseInfoCommandResponseForLast20txtn Exception>>" + e.toString());
        }
