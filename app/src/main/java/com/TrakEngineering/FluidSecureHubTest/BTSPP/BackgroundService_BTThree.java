...
public class BackgroundService_BTThree extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            ...
            if (extras == null) {
                ...
                Log.i(TAG, "-Started-");
                if (AppConstants.GenerateLogs) AppConstants.WriteinFile(TAG + "-Started-");
    ...
    private void transactionIdCommand(String transactionId) {
        ...
        try {
            ...
            if (IsThisBTTrnx) {
                BTSPPMain btspp = new BTSPPMain();
                btspp.send3(BTConstants.transaction_id_cmd +"T:"+ transactionId+";D:"+TransactionDateWithFormat+";V:"+VehicleNumber+";");
            } else {
                new Thread(new ClientSendAndListenUDPOne(BTConstants.transaction_id_cmd +"T:"+ transactionId+";D:"+TransactionDateWithFormat+";V:"+VehicleNumber+";", SERVER_IP, this)).start();
            }
            Log.i(TAG, "BTLink 3: In Request>>" + BTConstants.transaction_id_cmd +"T:"+ transactionId+";D:"+TransactionDateWithFormat+";V:"+VehicleNumber+";");
    ...
    private void UpdatetransactionToSqlite(String outputQuantity) {
        ...
        if (AppConstants.GenerateLogs)
            AppConstants.WriteinFile(TAG + "  BTLink:" + LinkName + " Pulses:" + Integer.parseInt(outputQuantity) + " Qty:" + fillqty + " TxnID:" + TransactionId);
        ...
        if (fillqty > 0) {
            ...
            //CommonUtils.SaveTransactionInSharedPreff(BackgroundService_BTThree.this,"4",counts);
    ...
    private  void parseInfoCommandResponseForLast20txtn(String response){
        ...
        try{
            ...
            //Log.i(TAG, "BTLink 2: parseInfoCommandResponseForLast20txtn Raw Data>>" + Response);
            //if (AppConstants.GenerateLogs)AppConstants.WriteinFile(TAG + "BTLink 2: parseInfoCommandResponseForLast20txtn Raw Data>>" + Response);
            ...
            e.printStackTrace();
            if (AppConstants.GenerateLogs)AppConstants.WriteinFile(TAG + "BTLink 3: parseInfoCommandResponseForLast20txtn Exception>>" + e.toString());
        }
