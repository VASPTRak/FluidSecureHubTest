...
public class BackgroundService_BTThree extends Service {
    ...
    public void ProceedToPostTransactionCommands() {
        ...
        if (CommonUtils.checkBTVersionCompatibility(versionNumberOfLinkThree, BTConstants.supportedLinkVersionForLast20) && IsEleventhTransaction.equalsIgnoreCase("true")) { // Last20 command supported from this version onwards
            last20Command();
        } else if (CommonUtils.checkBTVersionCompatibility(versionNumberOfLinkThree, BTConstants.supportedLinkVersionForBypassPumpReset)) { // Bypass pump reset command supported from this version onwards
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                if (Action.equalsIgnoreCase("BlueLinkThree")) {
                    ...
                    //if (AppConstants.GenerateLogs)AppConstants.WriteinFile(TAG + " BTLink_3: Link Response>>" + Response);
