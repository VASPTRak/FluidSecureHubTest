...
public class BackgroundService_BTTwo extends Service {
    ...
    public void ProceedToPostTransactionCommands() {
        ...
        if (CommonUtils.checkBTVersionCompatibility(versionNumberOfLinkTwo, BTConstants.supportedLinkVersionForLast20) && IsEleventhTransaction.equalsIgnoreCase("true")) { // Last20 command supported from this version onwards
            last20Command();
        } else if (CommonUtils.checkBTVersionCompatibility(versionNumberOfLinkTwo, BTConstants.supportedLinkVersionForBypassPumpReset)) { // Bypass pump reset command supported from this version onwards
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                if (Action.equalsIgnoreCase("BlueLinkTwo")) {
                    ...
                    //if (AppConstants.GenerateLogs)AppConstants.WriteinFile(TAG + " BTLink_2: Link Response>>" + Response);
