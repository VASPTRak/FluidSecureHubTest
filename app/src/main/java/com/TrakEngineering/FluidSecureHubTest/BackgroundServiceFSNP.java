            ...
            try {
                ...
                if (RespTxt.equalsIgnoreCase("success")) {
                    ...
                    if (SelectedHose.equalsIgnoreCase("0")) {
                        ...
                        CommonUtils.SaveVehiFuelInPref(BackgroundServiceFSNP.this, TransactionId, VehicleId, PhoneNumber, PersonId, PulseRatio, MinLimit, FuelTypeId, ServerDate, IntervalToStopFuel, PrintDate, Company, Location, PersonName, PrinterMacAddress, PrinterName, vehicleNumber, accOther, VehicleSum, DeptSum, VehPercentage, DeptPercentage, SurchargeType, ProductPrice, IsTLDCall1, EnablePrinter1, OdoMeter, Hours, PumpOnTime,"","","","", "false");
